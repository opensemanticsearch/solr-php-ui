...
$mimetypes=array(
		...
		'application/vnd.ms-powerpoint' => array ('name'=>'Powerpoint', 'icon'=>'archive.png'),
		'application/vnd.ms-excel' => array ('name'=>'Excel', 'icon'=>'archive.png'),
		...
		'application/msword' => array ('name'=>'Word', 'icon'=>'doc.png'),
